#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\chaos\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.271\\out\\buildHook\\index.js').default({tool: 'live-server'}); } catch(cjsError) { try { import('file:///c:/Users/chaos/.vscode/extensions/wallabyjs.console-ninja-1.0.271/out/buildHook/index.js').then(m => m.default.default({tool: 'live-server'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
